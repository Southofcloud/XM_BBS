...
##########覆盖之后cookie.txt失效##########
COOKIE=''
AUTOCOMMENT=False#修改为False则不自动复制热评回复
BOARDID='5433318'#需要在哪个板块操作 5433318--为开发版公测 5428803--开发版内测 ，请确保有对应的浏览权限。
##########################################
#点赞评论都是这种
base_header = {
...
def AutoLike(Client: XM_BBS, stype='lastest'):
    c = 0
    after=''
